...
def main() -> None:
    ...
    for exp_conf in tqdm(
        prepare_experiments_configs(), desc="QML_Training_Experiments"
    ):
        experiment_id = get_exp_id(exp_conf, "pixel-level")

        mlflow.start_run(experiment_id=experiment_id, description="Amplitude + Bellman")
